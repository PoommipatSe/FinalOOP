 ...
 * Create a node class which extends Data.AbstractNode and implements the sethCosts
 * method.
 * Create a Data.NodeFactory that implements the Data.NodeFactory interface.
 * Create Data.Map instance with those created classes.
 * @see ExampleUsage Data.ExampleUsage
 * <p>
 *
 * @see AbstractNode
 * @see NodeFactory
...
public class Map<T extends AbstractNode> {
    ...
    public void setWalkable(int x, int y, boolean bool) {
        ...
        nodes[x][y].setWalkable(bool); //Edit Here !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
