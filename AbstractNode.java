...
/**
 * This class represents an Data.AbstractNode. It has all the appropriate fields as well
 * as getter and setter to be used by the A* algorithm.
 * <p>
 * <p>
 * An <code>Data.AbstractNode</code> has x- and y-coordinates and can be walkable or not.
 * A previous Data.AbstractNode may be set, as well as the
 * <code>fCosts</code>, <code>gCosts</code> and <code>hCosts</code>.
 * <p>
 * <p>
 * <code>fCosts</code>: <code>gCosts</code> + <code>hCosts</code>
 * <p>
 * <code>gCosts</code>: calculated costs from start Data.AbstractNode to this Data.AbstractNode
 * <p>
 * <code>hCosts</code>: estimated costs to get from this Data.AbstractNode to end Data.AbstractNode
 * <p>
 * <p>
 * A subclass has to override the heuristic function
 * <p>
 * <code>sethCosts(Data.AbstractNode endAbstractNode)</code>
 * <p>
...
public abstract class AbstractNode {
    ...
    /** the previous Data.AbstractNode of this one on the currently calculated path. */
    private AbstractNode previous;

    /** weather or not the move from previous to this Data.AbstractNode is diagonally. */
    ...
    /** calculated costs from start Data.AbstractNode to this Data.AbstractNode. */
    private int gCosts;

    /** estimated costs to get from this Data.AbstractNode to end Data.AbstractNode. */
    private int hCosts;

    /**
     * constructs a walkable Data.AbstractNode with given coordinates.
     *
     * @param xPosition
     * @param yPosition
     */
    ...
    /**
     * returns the calculated costs from start Data.AbstractNode to this Data.AbstractNode.
     *
     * @return the gCosts
     */
    ...
    /**
     * sets gCosts to <code>gCosts</code> plus <code>movementPanelty</code>
     * for this Data.AbstractNode given the previous Data.AbstractNode as well as the basic cost
     * from it to this Data.AbstractNode.
     *
    ...
    /**
     * sets gCosts to <code>gCosts</code> plus <code>movementPanelty</code>
     * for this Data.AbstractNode given the previous Data.AbstractNode.
     * <p>
     ...
     *
     * @param previousAbstractNode
     * @param movementCost costs from previous Data.AbstractNode to this Data.AbstractNode.
     * @return gCosts
     */
    ...
    /**
     * returns estimated costs to get from this Data.AbstractNode to end Data.AbstractNode.
     *
     * @return the hCosts
     */
    ...
    /**
     * calculates hCosts for this Data.AbstractNode to a given end Data.AbstractNode.
